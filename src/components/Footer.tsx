      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Conectando clientes a prestadores de serviço de manutenção e
              reformas em todo o Brasil.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="#para-clientes" className="text-base text-gray-600 hover:text-primary">
                  Para Clientes
                </a>
              </li>
              <li>
                <a href="#para-prestadores" className="text-base text-gray-600 hover:text-primary">
                  Para Prestadores
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Conecta Brasil. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
